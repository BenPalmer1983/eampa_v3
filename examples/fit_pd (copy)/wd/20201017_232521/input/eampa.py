...
# PRINT HEADER
    ...
    print("# Atoms/sec:         ", end="")
    print(display.pad_l(g.benchmark['atomspersec'], 20), end="")
    print("# Interactions/sec:  ", end="")
    print(display.pad_l(g.benchmark['interationspersec'], 20), end="")
    print("# Configs:           ", end="")
    print(display.pad_l(g.benchmark['configs'], 20), end="")
    print()    
    display.print_line()

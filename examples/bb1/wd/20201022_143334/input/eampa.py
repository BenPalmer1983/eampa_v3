...
# PRINT HEADER
    ...
    print("   " , end="")
    print(g.pfdata['rss']['counter'], end="")
    print(g.pfdata['rss']['current'], end="")
    print(g.pfdata['rss']['best'], end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['a0'],8), end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['e0'],8), end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['b0_gpa'],8), end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['ec_gpa'][0,0],8), end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['ec_gpa'][0,1],8), end="")
    print(display.pad_r(g.bp_results['bp_calculations'][bp_id]['ec_gpa'][3,3],8), end="")
    print()

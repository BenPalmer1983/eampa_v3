...
# Print start screen
    ...
    print(g.pfdata['pool']['params'][0,:])
    print(g.pfdata['pool']['params'][1,:])
    print(g.pfdata['pool']['params'][2,:])
    print(g.pfdata['pool']['params'][3,:])
    print(pf_parameters.get_p())
    print(pf_parameters.get_p())
    print(pf_parameters.get_p())
...
# Shuffle
    ...
    for pn in range(pmax):
        pf_potential.update(g.pfdata['pool']['params'][pn, :], True)
        for fn in range(len(g.pot_functions['functions'])): 
          if(g.pot_functions['functions'][fn]['f_type_id'] == 2):
            print(pf_parameters.estimate_density(fn))

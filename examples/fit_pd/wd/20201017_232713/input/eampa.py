...
######################################
  ...
  benchmark = {'configs': 0, 'total_atoms': 0, 'total_interactions': 0, 'total_time': 0.0, 'atomspersec': 0.0, 'interationspersec': 0.0,}
...
# PRINT HEADER
    ...
    print("# Atoms/sec:         ", end="")
    print(display.pad_l(g.benchmark['atomspersec'], 22), end="")
    print("   # Interactions/sec:  ", end="")
    print(display.pad_l(g.benchmark['interationspersec'], 22), end="")
    print("   # Configs:           ", end="")
    print(display.pad_l(g.benchmark['configs'], 22), end="")
    print()    
    display.print_line()

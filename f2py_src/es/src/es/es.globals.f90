...
INTEGER(kind=StandardInteger) ::                        calc_keys_i(1:100, 1:10) = -1
REAL(kind=DoubleReal) ::                                calc_keys_r(1:100, 1:10) = 0.0D0
INTEGER(kind=StandardInteger) ::                        calc_configs(1:100, 1:100) = 0


REAL(kind=DoubleReal) ::                                surface_area(1:100, 1:3) = 0.0D0
INTEGER(kind=StandardInteger) ::                        number_count(1:100) = 0
REAL(kind=DoubleReal) ::                                surface_energy(1:100) = 0.0D0
REAL(kind=DoubleReal) ::                                surface_energy_mjmsq(1:100) = 0.0D0

...
class test:
  ...
  def run():
    ...
    test.fn = 'cubic_knot_spline_3'
    pf = numpy.asarray([26.0, 26.0, 1.0, 0.0, 10.0, 0.0, 6.5, 0.0, 0.0, 0.0])
    p =  numpy.asarray([2.4, 2.5, 2.6, 2.8, 3.0, 3.2, 3.5, 4.0, 4.2, 5.0, 1.0, 1.1, 1.0, 0.6, 0.5, 0.2, 0.23, 4.7, 0.21, 0.2]) 

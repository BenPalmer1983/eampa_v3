SUBROUTINE set_rss_total(rss_in)
!###########################################################
REAL(kind=DoubleReal), INTENT(IN) :: rss_in
!###########################################################
rss_weights(10) = rss_in 
END SUBROUTINE set_rss_total

SUBROUTINE set_rss_a0(rss_in)
!###########################################################
REAL(kind=DoubleReal), INTENT(IN) :: rss_in
!###########################################################
rss_weights(1) = rss_in 
END SUBROUTINE set_rss_a0
...
SUBROUTINE set_rss_neg_ec(rss_in)
!###########################################################
REAL(kind=DoubleReal), INTENT(IN) :: rss_in
!###########################################################
rss_weights_neg_ec = rss_in 
END SUBROUTINE set_rss_neg_ec

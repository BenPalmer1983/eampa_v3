...
IF(ALLOCATED(calc_cubic_cauchy_pressure))THEN
  DEALLOCATE(calc_cubic_cauchy_pressure)
END IF
IF(ALLOCATED(calc_cubic_tetragonal_shear))THEN
  DEALLOCATE(calc_cubic_tetragonal_shear)
END IF
IF(ALLOCATED(calc_cubic_shear_modulus))THEN
  DEALLOCATE(calc_cubic_shear_modulus)
END IF
IF(ALLOCATED(calc_cubic_cauchy_pressure_gpa))THEN
  DEALLOCATE(calc_cubic_cauchy_pressure_gpa)
END IF
IF(ALLOCATED(calc_cubic_tetragonal_shear_gpa))THEN
  DEALLOCATE(calc_cubic_tetragonal_shear_gpa)
END IF
IF(ALLOCATED(calc_cubic_shear_modulus_gpa))THEN
  DEALLOCATE(calc_cubic_shear_modulus_gpa)
END IF
IF(ALLOCATED(calc_cubic_stability))THEN
  DEALLOCATE(calc_cubic_stability)
END IF
IF(ALLOCATED(calc_stability))THEN
  DEALLOCATE(calc_stability)
END IF
...
ALLOCATE(calc_cubic_cauchy_pressure(1:max_bps))
ALLOCATE(calc_cubic_tetragonal_shear(1:max_bps))
ALLOCATE(calc_cubic_shear_modulus(1:max_bps))
ALLOCATE(calc_cubic_cauchy_pressure_gpa(1:max_bps))
ALLOCATE(calc_cubic_tetragonal_shear_gpa(1:max_bps))
ALLOCATE(calc_cubic_shear_modulus_gpa(1:max_bps))
ALLOCATE(calc_cubic_stability(1:max_bps))
ALLOCATE(calc_stability(1:max_bps))

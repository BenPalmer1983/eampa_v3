SUBROUTINE sort_2d_dp()
!#############################################################
!#############################################################
CALL CPU_TIME(start_time)
IF(make_key_table)THEN
  IF(sort_ascending)THEN
    CALL msort_2d_dp_asc_kt(arr_dp_2d, key_table)
  ELSE
    CALL msort_2d_dp_desc_kt(arr_dp_2d, key_table)
  END IF
ELSE
  IF(sort_ascending)THEN
    CALL msort_2d_dp_asc(arr_dp_2d)
  ELSE
    CALL msort_2d_dp_desc(arr_dp_2d)
  END IF
END IF
CALL CPU_TIME(end_time)
time = end_time - start_time
END SUBROUTINE sort_2d_dp
...
RECURSIVE SUBROUTINE msort_2d_dp_desc(arr)
!#############################################################
REAL(kind=DoubleReal), INTENT(INOUT) :: arr(:, :)
!#############################################################
INTEGER(KIND=StandardInteger) :: lhs_len, rhs_len
...
IF(SIZE(arr,1) .GT. 1)THEN
  ...
  CALL msort_2d_dp_desc(arr(1:lhs_len,:))
  CALL msort_2d_dp_desc(arr(lhs_len+1:SIZE(arr,1),:))
  ...
  END IF  
END IF
END SUBROUTINE msort_2d_dp_desc


RECURSIVE SUBROUTINE msort_2d_dp_asc_kt(arr, kt)
!#############################################################
REAL(kind=DoubleReal), INTENT(INOUT) :: arr(:,:)
...
IF(SIZE(arr,1) .GT. 1)THEN
  ...
  CALL msort_2d_dp_asc_kt(arr(1:lhs_len,:), kt(1:lhs_len))
  CALL msort_2d_dp_asc_kt(arr(lhs_len+1:SIZE(arr,1),:), kt(lhs_len+1:SIZE(arr,1)))
  ...
  END IF  
END IF
END SUBROUTINE msort_2d_dp_asc_kt




RECURSIVE SUBROUTINE msort_2d_dp_desc_kt(arr, kt)
!#############################################################
REAL(kind=DoubleReal), INTENT(INOUT) :: arr(:,:)
INTEGER(KIND=StandardInteger), INTENT(INOUT) :: kt(:)
!#############################################################
...
IF(SIZE(arr,1) .GT. 1)THEN
  ...
  CALL msort_2d_dp_desc_kt(arr(1:lhs_len,:), kt(1:lhs_len))
  CALL msort_2d_dp_desc_kt(arr(lhs_len+1:SIZE(arr,1),:), kt(lhs_len+1:SIZE(arr,1)))
  ...
  END IF  
END IF
END SUBROUTINE msort_2d_dp_desc_kt
